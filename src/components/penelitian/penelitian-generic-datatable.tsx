...
const getProgressPercentage = (status: StatusPenelitian) => {
  switch (status) {
    case StatusPenelitian.REVIEW:
      return 10;
    case StatusPenelitian.ACC_PROPOSAL:
                    ...
                    <TableRow key={penelitian.id}>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-gray-500">
                            Progress:{" "}
                            {getProgressPercentage(penelitian.statusPenelitian)}
                            %
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="flex items-center gap-2 justify-center">
                          ...
                          ].includes(penelitian.statusPenelitian) && (
                            <>
                              <Button
                                variant="outline"
                                size="sm"
                                onClick={() =>
                                  window.open(
                                    `/simlit/penelitian/surat-tugas?id=${penelitian.id}`,
                                    "_blank"
                                  )
                                }
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  window.open(
                                    `/simlit/penelitian/surat-pengambilan-data?id=${penelitian.id}`,
                                    "_blank"
                                  )
                                }
                                className="h-8 bg-white hover:bg-gray-100 text-gray-700 border-gray-200">
