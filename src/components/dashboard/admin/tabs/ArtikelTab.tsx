    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Semua artikel yang telah dibuat ({posts.length} artikel)
          </CardDescription>
        </CardHeader>
        <CardContent>
          {postsLoading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-500">
                Belum ada artikel. Tambah artikel pertama Anda!
              </p>
            </div>
          ) : (
                ...
                <div
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 mt-2 text-sm text-gray-600 ">
                      <span>
                        Penulis: {article.author.name || article.author.email}
                      </span>
                      <span>Tanggal: {formatDate(article.createdAt)}</span>
                      {article.location && (
                        <span>Lokasi: {article.location}</span>
                      )}
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Badge className="bg-blue-500 text-white">Artikel</Badge>
                    <Button
                      variant="outline"
                      size="sm"
