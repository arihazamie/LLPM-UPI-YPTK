...
export default function DaftarJurnalUpiYptkPage() {
  return (
    <main className="flex-1">
      {/* Hero Section for Daftar Jurnal UPI YPTK */}
      <section className="relative py-24 md:py-32 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 text-white/90 text-sm font-medium mb-8">
            ...
            <span>Publikasi • Ilmiah • Reputasi</span>
          </div>
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Akses daftar jurnal ilmiah yang dikelola atau berafiliasi dengan UPI
            YPTK Padang.
          </p>
        </div>
      </section>

      {/* Content Section for Daftar Jurnal UPI YPTK */}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Temukan berbagai jurnal ilmiah dari berbagai disiplin ilmu yang
              diterbitkan oleh UPI YPTK Padang.
            </p>
          </div>
          ...
          <Card className="group relative overflow-hidden border-0 shadow-xl bg-white/80 backdrop-blur-lg p-8 text-center">
            <CardHeader className="p-0 mb-4">
              <CardTitle className="text-2xl font-black text-gray-900">
                Belum Ada Daftar Jurnal
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <CardDescription className="text-gray-600 leading-relaxed">
                Mohon maaf, saat ini belum ada daftar jurnal yang tersedia.
