...
export default async function PimpinanDashboardPage() {
  ...
  return (
    <main className="flex-1">
      {/* Hero Section for Pimpinan Dashboard */}
      <section className="relative py-24 md:py-32 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 text-white/90 text-sm font-medium mb-8">
            ...
            <span>Strategi • Analisis • Keputusan</span>
          </div>
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Tinjau metrik kunci, laporan strategis, dan kinerja LPPM secara
            keseluruhan.
          </p>
        </div>
      </section>

      {/* Content Section for Pimpinan Dashboard */}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Di sini Anda dapat memantau kinerja, membuat keputusan strategis,
              dan melihat laporan ringkasan.
            </p>
          </div>
          ...
          <Card className="group relative overflow-hidden border-0 shadow-xl bg-white/80 backdrop-blur-lg p-8 text-center">
            <CardHeader className="p-0 mb-4">
              <CardTitle className="text-2xl font-black text-gray-900">
                Fitur Dashboard Pimpinan
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <CardDescription className="text-gray-600 leading-relaxed text-left">
                <>
                  Sebagai Pimpinan, Anda dapat:
                  <ul className="list-disc list-inside mt-4 space-y-2">
                    <li>
                      Melihat ringkasan kinerja penelitian dan pengabdian
                      masyarakat.
                    </li>
                    <li>Mengakses laporan strategis dan analisis data.</li>
                    <li>Memantau progres proyek-proyek utama.</li>
                    <li>Menyetujui atau menolak proposal dan anggaran.</li>
                    <li>
                      Melihat statistik publikasi dan dampak kegiatan LPPM.
                    </li>
                  </ul>
                </>
              </CardDescription>
