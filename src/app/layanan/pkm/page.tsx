  ...
  const handleAddPkm = async (pkmData: Partial<PKM>) => {
    try {
      ...
      const payload = {
        ...
        tanggalPelaksanaan: pkmData.tanggalPelaksanaan
          ? new Date(pkmData.tanggalPelaksanaan).toISOString().split("T")[0]
          : undefined,
        ...(Array.isArray(pkmData.artikel) && pkmData.artikel.length > 0
          ? {
              artikel: pkmData.artikel.map((a) => ({
                judul: a.judul,
                author: a.author,
                ...
                tanggalPublisher: a.tanggalPublisher,
              })),
            }
          : {}),
        ...(Array.isArray(pkmData.hki) && pkmData.hki.length > 0
          ? {
          ...
          : {}),
        ...(Array.isArray(pkmData.buku) && pkmData.buku.length > 0
          ? {
        ...
        <div className="relative z-10 container mx-auto p-8 space-y-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <PKMExcelExportButton disabled={isLoading || pkms.length === 0} />
              <Button
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-slate-900">
                        {pkms.reduce(
                          (total, pkm) => total + (pkm.artikel ? 1 : 0),
                          0
                        )}
                      </p>
                    </div>
