...
export default function RencanaIndukPenelitianPage() {
  return (
    <main className="flex-1">
      {/* Hero Section for Rencana Induk Penelitian */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-16 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Melihat dokumen strategis yang memandu arah penelitian LPPM UPI YPTK
            Padang.
          </p>
        </div>
      </section>

      {/* Content Section for Rencana Induk Penelitian */}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Dokumen ini berisi arah strategis dan prioritas penelitian LPPM
          ...
          <Card className="group relative overflow-hidden border-0 shadow-xl bg-white/80 backdrop-blur-lg p-8 text-center">
            ...
            <CardContent className="p-0">
              <CardDescription className="text-gray-600 leading-relaxed">
                Informasi detail mengenai Rencana Induk Penelitian akan segera
                ditambahkan di sini.
              </CardDescription>
            </CardContent>
          </Card>
