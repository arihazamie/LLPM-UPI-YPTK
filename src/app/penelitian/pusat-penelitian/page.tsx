...
export default function PusatPenelitianPage() {
  return (
    <main className="flex-1">
      {/* Hero Section for Pusat Penelitian */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 text-white/90 text-sm font-medium mb-8">
            ...
            <span>Inovasi • Eksplorasi • Penemuan</span>
          </div>
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Mengenal berbagai pusat penelitian yang ada di bawah naungan LPPM
            UPI YPTK Padang.
          </p>
        </div>
      </section>

      {/* Content Section for Pusat Penelitian */}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              LPPM memiliki beberapa pusat penelitian yang berfokus pada
          ...
          <Card className="group relative overflow-hidden border-0 shadow-xl bg-white/80 backdrop-blur-lg p-8 text-center">
            <CardHeader className="p-0 mb-4">
              <CardTitle className="text-2xl font-black text-gray-900">
                Informasi Pusat Penelitian
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <CardDescription className="text-gray-600 leading-relaxed">
                Detail mengenai pusat-pusat penelitian akan segera ditambahkan
                di sini.
              </CardDescription>
            </CardContent>
          </Card>
