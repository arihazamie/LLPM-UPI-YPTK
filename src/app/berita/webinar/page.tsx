      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 text-white/90 text-sm font-medium mb-8">
            ...
            <span>Edukasi • Online • Pengetahuan</span>
          </div>
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Dapatkan informasi terkini mengenai webinar dan seminar online yang
            diselenggarakan oleh LPPM.
          </p>
        </div>
      </section>

      {/* Content Section for Info Webinar */}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Informasi tentang webinar yang akan datang, topik, pembicara, dan
              cara pendaftaran.
            </p>
          </div>
          ...
          <Card className="group relative overflow-hidden border-0 shadow-xl bg-white/80 backdrop-blur-lg p-8 text-center">
            <CardHeader className="p-0 mb-4">
              <CardTitle className="text-2xl font-black text-gray-900">
                Belum Ada Info Webinar
              </CardTitle>
            </CardHeader>
            <CardContent className="p-0">
              <CardDescription className="text-gray-600 leading-relaxed">
                Mohon maaf, saat ini belum ada informasi webinar yang tersedia.
