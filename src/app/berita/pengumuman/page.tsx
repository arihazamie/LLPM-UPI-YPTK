      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 text-white/90 text-sm font-medium mb-8">
            ...
            <span>Pemberitahuan • Penting • Informasi</span>
          </div>
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Dapatkan pengumuman resmi dan informasi penting dari LPPM UPI YPTK
            Padang.
          </p>
        </div>
      </section>

      {/* Content Section for Pengumuman */}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Informasi terbaru mengenai kebijakan, program, dan kegiatan LPPM.
            </p>
          </div>
          ...
          <Card className="group relative overflow-hidden border-0 shadow-xl bg-white/80 backdrop-blur-lg p-8 text-center">
            ...
            <CardContent className="p-0">
              <CardDescription className="text-gray-600 leading-relaxed">
                Mohon maaf, saat ini belum ada pengumuman yang tersedia. Silakan
