...
import { Users, Sparkles } from "lucide-react"; // Icons for Staff LPPM
import Image from "next/image";

export default function StaffLppmPage() {
  const staffMembers = [
    {
      name: "[Nama Staf 1]",
      position: "Administrasi Penelitian",
      image: "/images/staff-placeholder.png", // Updated src
    ...
    {
      name: "[Nama Staf 3]",
      position: "Staf Publikasi Ilmiah",
      image: "/images/staff-placeholder.png", // Updated src
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-16 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 text-white/90 text-sm font-medium mb-8">
            ...
            <span>Staff • Profesional • Dukungan</span>
          </div>
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Mengenal tim profesional yang mendukung operasional dan program LPPM
            UPI YPTK Padang.
          </p>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Dedikasi dan keahlian staff kami adalah kunci keberhasilan setiap
              inisiatif LPPM.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {staffMembers.map((staff, index) => (
              <Card
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${staff.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}></div>
                <CardContent className="relative p-6 flex flex-col items-center">
                  <div className="relative w-24 h-24 rounded-full overflow-hidden mb-4 border-4 border-white shadow-lg group-hover:scale-105 transition-transform duration-300">
                    <Image
                  ...
                  <CardTitle className="text-lg font-black text-gray-900 group-hover:text-red-600 transition-colors mb-1">
                    {staff.name}
                  </CardTitle>
